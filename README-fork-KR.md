...
- 최신 [ViGEmBus 드라이버](https://github.com/nefarius/ViGEmBus/releases/latest)가 필요합니다.
...
1. 최신 ViGEmBus를 설치합니다.
2. Steam에서 네이티브 DualShock 4 입력으로 사용하려면 HidHide를 설치합니다.
3. 릴리즈 페이지에서 `SteamlessController.exe`를 내려받아 실행합니다.
4. 트레이 메뉴에서 `Output Mode -> DualShock 4`를 선택합니다.
